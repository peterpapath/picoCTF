# ANALYSIS
In this challenge, we need to correct the python code.  
  

# SOLUTION
In python, spaces and tabs play a significant role. We correct the last line and we run the program with `python3 fixme1.py` to get the flag.  
